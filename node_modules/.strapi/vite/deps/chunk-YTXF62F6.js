import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-CCW2GNPV.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-6SJDANS5.js";
import {
  LimitsModal
} from "./chunk-TRCEQJGN.js";
import {
...
} from "./chunk-GLAQRBXV.js";
import {
  useTypedSelector
} from "./chunk-6LQ57UBN.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-2GPEQBHA.js";
import {
  useConfig,
  useTracking
} from "./chunk-YCKIOBCD.js";
import {
  AssetSource,
  AssetType,
...
import {
  renderAdmin
} from "./chunk-GT4B3MIQ.js";
import {
  useAIAvailability
} from "./chunk-BEYSGNZB.js";
import {
  useLicenseLimits
} from "./chunk-QUGTTGLH.js";
import {
  Table,
  useTable
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-HJNNWZNW.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-NSNQM37J.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-DOQVSNDD.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-D5RCIWJW.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-ZFIFVLUQ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-MLF22QTQ.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-DY4OSFJG.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-2DHLUDNU.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-XEUSR7ZH.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-4SXDYIWR.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-THBHCK67.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-M4K745GI.js");
          return {
...
//# sourceMappingURL=chunk-YTXF62F6.js.map
